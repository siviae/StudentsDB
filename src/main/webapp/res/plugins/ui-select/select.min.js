...
!function () {
    ...
    var t = 0, i = angular.module("ui.select", []).constant("uiSelectConfig", {theme: "bootstrap", searchEnabled: !0, sortable: !1, placeholder: "", refreshDelay: 1e3, closeOnSelect: !0, generateId: function () {
        return t++
        ...
        return{link: function (e, t, i, c, l) {
            l(e, function (e) {
                t.append(e)
            })
        }}
    ...
    i.directive("uiSelectChoices", ["uiSelectConfig", "uisRepeatParser", "uiSelectMinErr", "$compile", function (e, t, i, c) {
            ...
            if (void 0 === e || !e._uiSelectChoiceDisabled) {
                ...
                if (!e || !e._uiSelectChoiceDisabled) {
                    if (p.tagging.isActivated) {
                        ...
                        }).length > 0)return p.close(i), void 0
                    }
        ...
        }, replace: !0, transclude: !0, require: ["uiSelect", "^ngModel"], scope: !0, controller: "uiSelectCtrl", controllerAs: "$select", compile: function (l, a) {
                ...
                l.$watch("$select.open", function (t) {
                    if (t) {
                        ...
                        b[0].style.visibility = "hidden", n(function () {
                            var t = c(a), i = c(b);
                            t.top + t.height + i.height > e[0].documentElement.scrollTop + e[0].documentElement.clientHeight && (b[0].style.position = "absolute", b[0].style.top = -1 * i.height + "px", a.addClass(x)), b[0].style.visibility = ""
                        })
                    } else {
                        if (null === b)return;
            ...
            d.multiple = !0, d.removeSelected = !0, d.focusInput = d.searchInput, p.$parsers.unshift(function () {
                ...
                if (e.isVerticalMovement(t.which) || c.$evalAsync(function () {
                    ...
                    if (void 0 !== d.tagging.fct) {
                        ...
                        if (o(r.concat(d.selected)))return p && (a = r, c.$evalAsync(function () {
        ...
        return{restrict: "EA", require: ["^uiSelect", "^ngModel"], link: function (c, l, s, n) {
            var a = n[0], r = n[1];
            ...
            i(o)(c), a.focusser = o, a.focusInput = o, l.parent().append(o), o.bind("focus", function () {
                ...
                return t.which === e.BACKSPACE ? (t.preventDefault(), t.stopPropagation(), a.select(void 0), c.$apply(), void 0) : (t.which === e.TAB || e.isControl(t) || e.isFunctionKey(t) || t.which === e.ESC || ((t.which == e.DOWN || t.which == e.UP || t.which == e.ENTER || t.which == e.SPACE) && (t.preventDefault(), t.stopPropagation(), a.activate()), c.$digest()), void 0)
        ...
        return{require: "^uiSelect", link: function (t, c, l, s) {
